...
namespace CommonLib
{
  ...
  void common_lib::PKG_VERSION(const std::string& pkg_mode_)
  {
    ...
    std::cout << "Author          : yjz"                                  << std::endl;
    std::cout << "Modify Author   : guoJian"                              << std::endl;
    std::cout << "SLAM mode       : " << pkg_mode_                        << std::endl;
    std::cout << "Package version : v0.0.1"                               << std::endl;
    std::cout << "Package link    : https://github.com/qqngwzlb"          << std::endl;
